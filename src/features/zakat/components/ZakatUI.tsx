...
export function InputGroup({
  ...
  return (
    <div>
      ...
      <div className="bg-gray-50 rounded-xl px-4 py-3 flex items-center justify-between border border-transparent focus-within:border-rose-500 focus-within:bg-white transition-all">
