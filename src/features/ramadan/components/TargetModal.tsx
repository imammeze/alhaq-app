          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-50 border border-gray-100 rounded-2xl px-4 py-3.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:bg-white transition-all"
              />
            </div>
            <div>
              <label className="text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-2 block">
            ...
            <button
              onClick={handleSave}
              disabled={!title.trim()}
              className="w-full mt-6 py-4 rounded-2xl bg-[#064e3b] text-white font-bold text-sm shadow-md hover:bg-emerald-900 disabled:opacity-50 disabled:bg-gray-300 disabled:shadow-none active:scale-[0.98] transition-all flex items-center justify-center gap-2">
